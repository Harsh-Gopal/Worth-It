    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
      <div>
        ...
        <div className="relative">
          <input 
            type="number" 
            className="bg-[var(--bg-main)] border border-[var(--border-color)] text-white text-sm rounded-lg focus:ring-1 focus:ring-[var(--color-brand-green)] focus:border-[var(--color-brand-green)] block w-full p-2 outline-none font-bold" 
            placeholder="50"
      ...
      <div>
        ...
        <div className="relative">
          <input 
            type="number" 
            className="bg-[var(--bg-main)] border border-[var(--border-color)] text-white text-sm rounded-lg focus:ring-1 focus:ring-[var(--color-brand-green)] focus:border-[var(--color-brand-green)] block w-full p-2 pl-7 outline-none font-bold" 
            placeholder="e.g. 500"
      ...
      <div className="flex items-center mt-6">
        <label className="relative flex items-center cursor-pointer group">
          ...
          <span className="ml-2 text-sm font-bold text-[var(--text-secondary)] group-hover:text-white transition-colors">Historical Low Only</span>
        </label>
      </div>
    </div>
  );
