...
log = logging.getLogger("tata_neu")

class TataNeuClient(PlatformClient):
    """Tata Neu (BigBasket integration) platform client.
    
    Pending implementation: Requires reverse-engineering Tata Neu's
