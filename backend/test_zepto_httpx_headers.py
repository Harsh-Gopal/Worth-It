...
async def main():
    ...
    async with async_playwright() as p:
        ...
        try:
            await page.goto("https://www.zeptonow.com/", wait_until="commit", timeout=15000)
    ...
    async with httpx.AsyncClient(cookies=cookies_dict, http2=True) as client:
        resp = await client.post("https://bff-gateway.zepto.com/user-search-service/api/v3/search", headers=headers, json=body)
